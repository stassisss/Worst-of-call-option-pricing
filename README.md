...
- **Greeks:** computed with central finite differences (bumping) across the spot range
- **Correlation sensitivity:** option price computed under different correlation [−0.8, 0.95]
